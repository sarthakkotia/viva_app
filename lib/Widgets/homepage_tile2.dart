...
class HomePageCard2 extends StatefulWidget {
  final String imgUrl;
  final String title;
  final String genre;
  final DateTime date;
  ...
  @override
  State<HomePageCard2> createState() => _HomePageCardState();
}
...
class _HomePageCardState extends State<HomePageCard2> {
  @override
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Stack(fit: StackFit.expand, children: [
        ...
        Positioned(left: 10, child: Text("hio"))
      ]),
      // Stack(
